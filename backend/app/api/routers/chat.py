...
@router.post("/chat", response_model=Union[ChatResponse, None])
...
async def get_conversation_endpoint(
    ...
    return await chat_service.get_conversation(session=db, conversation_id=conversation_id)
...
async def delete_conversation_endpoint(
    ...
    success = await chat_service.delete_conversation(session=db, conversation_id=conversation_id)
    if not success:
